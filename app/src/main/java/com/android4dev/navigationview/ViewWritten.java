...
public class ViewWritten extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.child_nfc_layout_justshow);
        ...
        btn=(Button) findViewById(R.id.gotomain);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent_name.setClass(ViewWritten.this, MainActivity.class);
