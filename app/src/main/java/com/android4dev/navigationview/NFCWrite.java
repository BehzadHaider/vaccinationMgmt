...
public class NFCWrite extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.new_write_nfc_layout);
       ...
       bt=(Button)findViewById(R.id.ToWrite);
        ...
        bt.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent activityChangeIntent = new Intent(NFCWrite.this, ViewWritten.class);

                // currentContext.startActivity(activityChangeIntent);

                NFCWrite.this.startActivity(activityChangeIntent);
            }
        });
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (message != null) {
                    dialog = new ProgressDialog(NFCWrite.this);
